...
PERMISSION() {
    MYIP=$(wget -qO- ipv4.icanhazip.com);
    IZIN=$(curl -sS https://raw.githubusercontent.com/donaya365/IP/main/access | awk '{print $2}' | grep $MYIP)
    if [[ "$MYIP" = "$IZIN" ]]; then
        Bloman
    else
...
clear
#echo -e "${red}♦️${NC} ${green}Established By donaya365 2022${NC} ${red}♦️${NC}"
