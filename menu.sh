...
cek=$( curl -sS https://raw.githubusercontent.com/donaya365/IP/main/access | awk '{print $2}'  | grep $MYIP )
Name=$(curl -sS https://raw.githubusercontent.com/donaya365/IP/main/access | grep $MYIP | awk '{print $4}')
if [[ $cek = $MYIP ]]; then
...
echo -e "Telegram : t.me/donaya365"
exit 0
fi
clear

BURIQ() {
    curl -sS https://raw.githubusercontent.com/donaya365/IP/main/access >/root/tmp
...
PERMISSION() {
    MYIP=$(wget -qO- ipv4.icanhazip.com);
    IZIN=$(curl -sS https://raw.githubusercontent.com/donaya365/IP/main/access | awk '{print $3}' | grep $MYIP)
    if [[ "$MYIP" = "$IZIN" ]]; then
        Bloman
    else
...
Exp=$(curl -sS https://raw.githubusercontent.com/donaya365/IP/main/access | grep $MYIP | awk '{print $3}')
fi
